...
Also for bonus material, there is a section on Creating your own RAG code to vector your files for use with the LLM and then also 
on how to reduce hallucinations using "GhostDriftProtocol" to reduce the chance by using multiple infrences to create a cross
check hash to validate the response.
